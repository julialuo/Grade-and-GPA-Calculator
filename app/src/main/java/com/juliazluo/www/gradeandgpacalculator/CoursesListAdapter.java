...
public class CoursesListAdapter extends ArrayAdapter<Course> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView courseName = (TextView) rowView.findViewById(R.id.courses_list_name);
        TextView courseCredits = (TextView) rowView.findViewById(R.id.courses_list_credits);
        TextView courseAverage = (TextView) rowView.findViewById(R.id.courses_list_average);
